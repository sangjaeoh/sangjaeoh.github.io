var store = [{
        ...
        "excerpt":"도메인 주도 개발 시작하기: DDD 핵심 개념 정리부터 구현까지 책을 읽고 내용을 아주 간단하게 정리한 글입니다. 1. 도메인 모델 시작하기 1.1 도메인이란? 소프트웨어로 해결하고자 하는 문제 영역을 도메인이라 한다. 1.2 도메인 전문가와 개발자 간 지식공유 “Garbage in, Garbage out” 잘못된 값이 들어가면 잘못된 결과가 나온다. 전문가나 관련자가 요구한 내용이 항상...","categories": ["etc","books"],
        "tags": ["books","DDD"],
