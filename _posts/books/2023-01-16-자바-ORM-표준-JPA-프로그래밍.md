...
[스프링 데이터 JPA를 이용한 조회 기능](/books/도메인주도개발시작하기/#5-스프링-데이터-jpa를-이용한-조회-기능){:target="_blank"} 참고
<br/>
<br/>
<br/>
...
[AttributeConverter를 이용한 밸류 매핑 처리](/books/도메인주도개발시작하기/#434-attributeconverter를-이용한-밸류-매핑-처리){:target="_blank"} 참고
<br/>
<br/>
